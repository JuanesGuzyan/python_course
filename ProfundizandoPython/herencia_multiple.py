...
# isinstance - va a regresar verdadero si coincide con alguna de las clases en el listado que aparezcan en el mro
print('Es entero: ', isinstance(10, int))
print('Es cadena: ', isinstance('Hola', str))
print('Es lista enteros ordena: ', isinstance(lista_enteros_ordenada, ListaEnterosOrdenada))
