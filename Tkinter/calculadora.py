...
class Calculadora(tk.Tk):
    def __init__(self):
        ...
        # Caja de texto (input)
        self.entrada = None
        # StringVar lo utilizamos para obtener u actualizar el valor del input
    ...
    def _creacion_componentes(self):
        ...
        boton_dividir = tk.Button(botones_frame, text='/', width=10, height=3, bd=0,
                                  bg='#eee', cursor='hand2', command=lambda: self._evento_clic('/')
                                  )
        ...
        boton_nueve.grid(row=1, column=2, padx=2, pady=1)
        ...
        boton_cero = tk.Button(botones_frame, text='0', width=21, height=3,
                               bd=0, bg='#fff', cursor='hand2', command=lambda: self._evento_clic(0))
        boton_cero.grid(row=4, column=0, columnspan=2, padx=1, pady=1)
        boton_punto = tk.Button(botones_frame, text='.', width=10, height=3,
                                bd=0, bg='#eee', cursor='hand2', command=lambda: self._evento_clic('.'))
        boton_punto.grid(row=4, column=2, padx=1, pady=1)

        boton_evaluar = tk.Button(botones_frame, text='=', width=10, height=3, bd=0,
