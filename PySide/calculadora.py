...
class Calculadora(QMainWindow):
    def __init__(self):
        ...
        # Metodos para crear la parte visual
    ...
    def _crear_area_captura(self):
        ...
        # Agregamos la linea al layout principal
    ...
    def _crear_botones(self):
        ...
        # Creamos los botones y se agregan al grid layout
    ...
    def _conectar_botones(self):
        ...
        for text_boton, boton in self.botones.items():
            ...
            # Conectamos el boton de limpiar texto
